...
namespace QL_cửa_hàng_sách
{
    public partial class Form1 : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn cần nhập đầu đủ thông tin");
            }
        }
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            else if (checkBox1.Checked && checkBox2.Checked)
            {
                ...
                for (int i = 0; i < dataGridViewKho.Rows.Count - 1; i++)
                {
                    if (dataGridViewKho[0, i].Value.ToString() == txtLoaiSach1.Text && dataGridViewKho[2, i].Value.ToString() == txtTacGia1.Text)
                    {
                        dataGridViewTimKiem.Rows.Add(dataGridViewKho[0, i].Value, dataGridViewKho[1, i].Value, dataGridViewKho[2, i].Value);
                    }
                }
                        ...
                        for(int i = 0; i < dataGridViewKho.Rows.Count - 1; i++)
                        {
                            ...
                            if(dataGridViewKho[1,i].Value.ToString() == txtTenSach1.Text)
                            {
                                ...
                                if (Convert.ToInt32(dataGridViewKho[4,i].Value) - Convert.ToInt32(txtSoLuong1.Text) >= 0)
                                {
                                    ...
                                    dataGridViewMua.Rows.Add(dataGridViewKho[0, i].Value, txtTenSach1.Text,
                                        txtSoLuong1.Text, TienLai.ToString(), dateTimePicker1.Text);
        ...
        private void btnThongKe_Click(object sender, EventArgs e)
        {
            if (checkBox3.Checked)
            {
                ...
                for (int i = 0; i < dataGridViewMua.Rows.Count - 1; i++)
                {
                    ...
                    {
                        dataGridViewThongKe.Rows.Add(dataGridViewMua[0,i].Value, dataGridViewMua[1, i].Value, dataGridViewMua[2, i].Value, dataGridViewMua[3, i].Value,
                            dataGridViewMua[4, i].Value);
                    }
                }
            }
